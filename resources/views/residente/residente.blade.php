            ...
            <form id="Formulario1" action="" method="post">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="form-floating fv-row">
                                <select id="NacionalidadIdInput" name="NacionalidadId" class="form-select" data-control="select2" data-placeholder="Seleccione" data-hide-search="true">
                                    <option></option>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="form-floating fv-row">
                                ...
                                <label for="EnabledInput3" class="form-label">Estado</label>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content" id="div-bloquear-espacio">
            <div class="modal-header bg-light p-2 ps-5">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 id="modal-titulo-acceso" class="modal-title text-uppercase">Hoja de Vida Residente</h2>
...
<div class="modal modal-xl modal-custom fade" tabindex="-1" id="editar-espacio" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog mt-20">
        <div class="modal-content" id="div-bloquear-espacio-registrar">
            <div class="modal-header bg-light p-2 ps-5">
                <h2 id="modal-titulo-acceso-registrar" class="modal-title text-uppercase">Registrar Hoja de Vida
                </h2>
            ...
            <form id="Formulario-Compone" action="" method="post">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            <div class="form-floating fv-row">
                                <select id="ComunidadIdInputCom" name="ComunidadId" class="form-select" data-control="select2" data-placeholder="Seleccione" data-hide-search="true">
                                    <option></option>
                                    @foreach($Comunidades as $comunidad)
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="form-floating fv-row">
                                <select id="PropiedadIdInputCom" name="PropiedadId" class="form-select" data-control="select2" data-placeholder="Seleccione" data-hide-search="true">
                                    <option></option>
                                    @foreach($Propiedades as $propiedad)
                                    <option value="{{ $propiedad->Id }}">{{ $propiedad->Nombre }}</option>
                                    @endforeach
                                </select>
                                <label for="PropiedadIdInputCom" class="form-label">Propiedad</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="form-floating fv-row">
                                <select id="RolIdInputCom" name="RolId" class="form-select" data-control="select2" data-placeholder="Seleccione" data-hide-search="true">
                                    <option></option>
                ...
                <div class="modal-footer bg-light p-2">
                    <button type="button" class="btn btn-light-dark" data-bs-dismiss="modal">Cerrar</button>
                    <button id="AddSubmitCom" type="submit" class="btn btn-success">
                        <div class="indicator-label">Registrar</div>
                        <div class="indicator-progress">Espere...
                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                        </div>
...
<script>
    ...
    const CambiarEstadoPersona = "{{ route('CambioEstadoPersona') }}";
...
<script src="{{ asset('js/eventos/compone.js') }}"></script>
<!--end::Javascript-->
